...
void clientSide2(int port,string outputFile)throw (const char*){
	...
	ofstream out(outputFile);
	ifstream in("/home/rapps/CLionProjects/Advanced-programming-1/input.txt");
	string input="";
	while(input!="6"){
		readMenue(out,serverFD);
		getline(in,input);			
...
int main(){
	...
	size_t mistakes = check(outputFile1,"/home/rapps/CLionProjects/Advanced-programming-1/expected_output_menu.txt");
	mistakes += check(outputFile2,"/home/rapps/CLionProjects/Advanced-programming-1/expected_output.txt");
